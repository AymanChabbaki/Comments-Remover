...
export default function DataDeletionPage() {
  return (
    <div className="bg-grain relative flex min-h-screen flex-col items-center gap-8 bg-paper px-6 py-16">
      <Logo variant="full" height={44} />

      <div className="w-full max-w-xl rounded-xl border border-line bg-surface p-8 shadow-[0_1px_2px_rgba(31,36,44,0.04)]">
        ...
        <p className="mt-4 text-sm leading-relaxed text-ink-soft">
          ...
          <a href="mailto:hello@techermanos.org?subject=Data%20deletion%20request" className="font-semibold text-brand-600 hover:underline">
