...
const SYSTEM_PROMPT =
  ...
  'harassment, spam, a scam, or otherwise toxic; if it expresses any ' +
  ...
  'not recommend it; or if it is meaningless noise rather than a genuine ' +
  'comment -- gibberish, keyboard mashing, random or placeholder/test text ' +
  '(e.g. "null", "test", "asdf"), or a single word with no real relevance ' +
  'to the page or post. Keep it only if it is a genuine, meaningful comment ' +
  'that is neutral or positive -- including short genuine reactions like ' +
  '"nice!" or an emoji. Respond with exactly one word: DELETE or KEEP. Do ' +
